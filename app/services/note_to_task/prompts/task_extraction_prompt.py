...
prompt_template = ChatPromptTemplate.from_messages([
    (
        ...
        "\n- is_ai_task=true: AIが事前にやっておけるタスク（人間が実行するタスクの準備として）"
        "\n  主なパターン:"
        "\n  - 事前の調べ物・調査（情報収集、データ分析、競合調査など）"
        "\n  - 文章や資料の原案作成（下書き、アウトライン、要点整理など）"
        "\n  - データの整理・要約（情報の構造化、レポートの準備など）"
        "\n  - 定期的な情報収集・監視（ニュースまとめ、市場動向チェックなど）"
        "\n- is_ai_task=false: 人間が実行するタスク（デフォルト）"
        "\n※ 判断基準: 人間が実行するタスクの前に、AIが事前に準備・調査・原案作成などをしておくと効率的な場合、is_ai_task=trueを設定"
