...
async def generate_tasks_from_note(note_id: int, note_text: str, user_id: str) -> List[Task]:
    """
    ...
    # TaskCreateモデルに変換（user_idとsource_note_idを追加）
    # AIが生成したsource_note_idを除外し、確実に正しいnote_idを設定
    tasks_to_create = [
        TaskCreate(
            user_id=user_id,
