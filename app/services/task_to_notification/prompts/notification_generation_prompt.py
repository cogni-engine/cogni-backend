...
- 締切までの残り時間が1時間未満でない限り、通知同士の間隔は最低でも1時間以上空けてください。締切まで期間が長い場合は、1日後・3日後・1週間後・2週間後など十分な間隔を確保してください
- 締切が設定されていない場合は、現在時刻・1日後・3日後・1週間後といったデフォルトの間隔を基準に、3〜5件の通知を等間隔に近い形で配置してください
...
- 締切までの残り時間が1時間未満でない限り、通知同士の間隔は最低でも1時間以上空けてください。締切が遠い場合は1日後・3日後・1週間後・2週間後など適切な間隔を活用してください
- 締切がない、あるいはタスクによって締切がばらつく場合は、代表となる期限やタスクの性質を踏まえて、現在時刻・1日後・3日後・1週間後・2週間後といった等間隔スケジュールを基準に3〜5件の通知を配置してください
