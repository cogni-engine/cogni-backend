...
from app.models.notification import Notification, NotificationCreate, NotificationUpdate, NotificationStatus
...
class NotificationRepository(BaseRepository[Notification, NotificationCreate, NotificationUpdate]):
    ...
    async def mark_sent(self, notification_id: int) -> Notification:
